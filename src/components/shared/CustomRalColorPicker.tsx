...
export function CustomRalColorPicker({
  ...
  return (
    <div className="space-y-3">
      ...
      {/* Selected-colour summary chip removed — the consuming page already
          renders its own confirmed-colour preview directly below the picker,
          so showing it inline here just duplicated the same information. */}
    </div>
  )
}
